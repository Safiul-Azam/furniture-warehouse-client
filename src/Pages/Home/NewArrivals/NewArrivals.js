...
const NewArrivals = () => {
  ...
  useEffect(() => {
    fetch("https://furniture-9cwv.onrender.com/arrival")
      .then((res) => res.json())
  ...
  return (
    <div className="arrivals-section">
      <div className="d-flex align-items-center w-25 mx-auto">
        ...
        <div>
          <h3 className="text-center mt-3 mx-3">
            New <span className="title-color">Arrivals</span>
          </h3>
        </div>
        <div style={{ height: "2px" }} className="line-color w-25"></div>
      </div>
      {arrivals.map((arrival) => (
        <div className="container" key={arrival._id}>
          <div className=" d-flex align-items-center row">
            <div className="arrival-info col-lg-6 col-12">
              ...
              <button variant="outline-dark" className="update-arrival-btn">
                Update
              </button>
            </div>
