...
const UpdateInventory = () => {
    ...
    return (
        <div className='container product-details my-5'>
            <div className='col-5'>
                <h2 className='text-center mt-3'>Previous <span className='title-color'>Information</span></h2>
            ...
            <div className='col-7'>
                <div className='w-50 mx-auto my-5'>
                    <h2 className='text-center my-3'>Update <span className='title-color'>Inventory</span></h2>
                    <form className='d-flex flex-column' onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input className='mb-2 p-2' placeholder='Product Quantity' type="number" {...register("quantity",)} />
